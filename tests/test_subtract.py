...
from mathematic.arithmetic import subtract_as_ints, subtract_with_additional_code
...
def test_subtraction():
    ...
    asssert_equal(expected, subtract_with_additional_code, ['0'], ['0'])

    # 1 - 0
    expected = ['0', '0', '0', '0', '0', '0', '0', '1']
    asssert_equal(expected, subtract_with_additional_code, ['1'], ['0'])

    # 10 - 0
    expected = ['0', '0', '0', '0', '0', '0', '1', '0']
    asssert_equal(expected, subtract_with_additional_code, ['1', '0'], ['0'])

    # 10 - 01
    expected = ['0', '0', '0', '0', '0', '0', '1', '1']
    asssert_equal(expected, subtract_with_additional_code, ['1', '0'], ['1'])


def test_minus_more_ranks():
    """
    Проверка вычитания
    """
